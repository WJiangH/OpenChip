...
2. Assign one bounded work item to a specialist and a different independent
   ...
   limits and required receipts. Read [operating.md](references/operating.md)
...
Steward stable public documentation while preserving specialist ownership of
specifications, ADRs and testplans. Publish reusable methods only. Actual goals, conversations, credentials, worker
